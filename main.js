    ...
    switch (text) {
        ...
        case 'Відправити до Мюнхену':
            const responseTextsTwo = {
                'Відправити до Братислави': 'Приймаємо посилки зі всієї України новою поштою: у м. Львові, відділення №1, на імя Радченко Ілля 0954590000. Посилка обовязково має бути підписаною, потрібно вказати 📝Братислава, 📝Прізвище, імя отримувача, 📝К-тний № тел. отримувача. Вартість пересилки 1€/кг за звичайні речі. Мінімальна вартість відправлення 10€',
